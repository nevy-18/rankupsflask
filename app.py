...
# =========================================================
# DATABASE CONFIGURATION (Dynamic setup for Vercel + XAMPP)
# =========================================================
# Checks Vercel environment variables first. Falls back to local XAMPP if not found.
raw_uri = os.environ.get('DATABASE_URL', 'mysql+pymysql://root:@localhost/finalrankup')

# SQLAlchemy strictly requires the connection string protocol prefix to be 'mysql+pymysql://'
